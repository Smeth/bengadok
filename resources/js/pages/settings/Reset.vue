            ...
            <div class="space-y-6">
                ...
                >
                    <p class="text-sm text-amber-800 dark:text-amber-200">
                        ...
                        l'application et réexécutera les migrations avec les
                        seeders. Vous serez déconnecté et devrez vous
                        reconnecter.
                    </p>
                </div>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                ...
                                l'application ? Toutes les données seront
                                supprimées et remplacées par les données de
