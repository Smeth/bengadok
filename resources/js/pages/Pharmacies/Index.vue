...
function toggleGarde(pharmacie: Pharmacie, e: Event) {
    e.preventDefault();
    router.patch(
        `/pharmacies/${pharmacie.id}/toggle-garde`,
        {},
        { preserveScroll: true },
    );
}
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
                ...
                >
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        >
                            ...
                            <Button
                                :variant="
                                    viewMode === 'carte' ? 'secondary' : 'ghost'
                                "
                                size="sm"
                                class="rounded-md h-8 px-3 font-semibold transition-colors"
                                :class="
                    ...
                    <table class="w-full min-w-[920px] table-fixed text-sm">
                        <thead class="bg-muted/50">
                            <tr>
                                ...
                                <th
                                    class="min-w-[130px] px-4 py-3 text-left font-medium"
                                >
                                    Tél
                                </th>
                                <th
                                    class="min-w-[100px] shrink-0 px-4 py-3 text-left font-medium"
                                >
                                    Heures
                                </th>
                                <th
                                    class="min-w-[120px] shrink-0 px-4 py-3 text-left font-medium"
                                >
                                    Statut
                                </th>
                                <th
                                ...
                                <th
                                    class="min-w-[180px] shrink-0 px-4 py-3 text-right font-medium"
                                >
                                    Actions
                                </th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="max-w-[200px] px-4 py-3">
                                    ...
                                    >
                                        <div
                                            class="flex size-8 shrink-0 items-center justify-center rounded-lg bg-sky-100 text-sky-600"
                                        >
                                            <Building2 class="size-4" />
                                        </div>
                                        <span
                                ...
                                >
                                    {{
                                        pharmacie.heurs
                                            ? `${pharmacie.heurs.ouverture} - ${pharmacie.heurs.fermeture}`
                                            : '-'
                                    }}
                                </td>
                                <td class="px-4 py-3">
                                ...
                                <td
                                    class="whitespace-nowrap px-4 py-3 text-muted-foreground"
                                >
                                    {{ pharmacie.users_count }} Utilisateur(s)
                                </td>
                                <td class="px-4 py-3">
                                    <div
                                    ...
                                    >
                                        ...
                                        <Button
                                            ...
                                            @click="openDeleteModal(pharmacie)"
                                        >
                                            <Trash2 class="size-4" />
                                        </Button>
                                    </div>
            ...
            >
                ...
                >
                    ...
                    <div
                        class="absolute top-6 right-6 flex items-end gap-1.5 flex-col"
                    >
                        <span
                            v-if="
                                pharmacie.type_pharmacie?.designation
                        ...
                        <span
                            v-if="pharmacie.de_garde"
                            class="rounded-lg bg-red-600 px-2.5 py-0.5 text-[10px] font-bold text-white uppercase tracking-wider"
                        >
                            De Garde
                        </span>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <span class="truncate" :title="pharmacie.email">{{
                                pharmacie.email
                            }}</span>
                        </p>
                    </div>
                    ...
                    <div class="mb-5 rounded-[12px] border border-gray-200 p-3">
                        ...
                        <p
                            v-if="pharmacie.proprio_tel"
                            class="text-[12px] text-gray-500 mt-0.5"
                        >
                            <Phone
                                class="size-3 inline-block mr-1 text-gray-400"
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="flex items-center gap-2">
                            <Button
                                variant="secondary"
                                class="flex-1 bg-[#6c757d] text-white hover:bg-[#5a6268] h-10 rounded-[10px] font-bold shadow-sm"
                                as-child
                            >
                            ...
                            <Button
                                variant="outline"
                                class="h-10 w-10 p-0 rounded-[10px] border border-red-200 bg-white text-red-600 hover:bg-red-50 hover:text-red-700 shadow-sm shrink-0"
                                @click="openDeleteModal(pharmacie)"
                            >
        ...
        <Dialog :open="showModal" @update:open="showModal = $event">
            <DialogContent
                class="max-h-[90vh] max-w-[min(28rem,calc(100vw-2rem))] overflow-y-auto overflow-x-hidden"
            >
                <DialogHeader>
                    ...
                    >
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                />
                                <p
                                    v-if="errors.proprio_email"
                                    class="text-sm text-red-600"
                                >
                                    {{ errors.proprio_email }}
                                </p>
                            </div>
                            <div class="space-y-2">
        ...
        <ConfirmModal
            ...
            :description="
                pharmacieToDelete
                    ? `Êtes-vous sûr de vouloir supprimer « ${pharmacieToDelete.designation} » ? Cette action est irréversible.`
                    : ''
            "
